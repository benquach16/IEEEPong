...
namespace WongPong {
    ...
    public class Player {
        ...
        //Constructor
        public Player(ContentManager content, Color newcolor, Color newcolor2, int newtype = 1)
        {
            ...
            if (type == 1) position = new Vector2(30, MainForm.ScreenHeight / 2 - texture.Height / 2);
            else if (type == 2) position = new Vector2(MainForm.ScreenWidth - texture.Width - 30, MainForm.ScreenHeight / 2 - texture.Height / 2);
        ...
        //Update method
        public void Update(int gametime,Vector2 playerHand) {
            ...
            if (position.Y >= MainForm.ScreenHeight - texture.Height) position.Y = MainForm.ScreenHeight - texture.Height;
