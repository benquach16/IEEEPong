...
namespace WongPong {
    public class Ball {
        ...
        public Texture2D particleTexture; //particles' texture
        ...
        public Ball(ContentManager content) {
            ...
            maxParticleLife = 20;
            position = new Vector2(MainForm.ScreenWidth / 10, MainForm.ScreenHeight / 2);
            velocity = new Vector2(15f, 0);
            maxVelocity = new Vector2(30, 15);
        ...
        //update method
        public void Update(int elapsed, bool pause) {
        ...
        public void PaddleHit(Color newcolor) {
            ...
            int xMax, xMin;
            if (position.X > MainForm.ScreenWidth/ 2) { xMax = 0; xMin = -10; }
            else { xMax = 10; xMin = 0; }
        ...
        public void Kill() {
            ...
            position = new Vector2(MainForm.ScreenWidth / 2, MainForm.ScreenHeight / 2);
            boundingBox.X = (int)position.X; boundingBox.Y = (int)position.Y;
        }
